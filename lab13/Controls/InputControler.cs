...
public partial class InputControler : Connectable
{
    ...
    public InputControler()
    {
        ...
        BoolArrayOut = new List<bool>(Enumerable.Repeat(false, CountInput));
    }
    ...
    protected override void OnPointerMoved(PointerEventArgs e)
    {
        ...
        //this.pos = new Point(offsetX, offsetY);
